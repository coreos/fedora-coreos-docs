...
Each tutorial has it's roots in it's previous tutorial scenario and it's recommended to follow it sequentially.

xref:getting-started-tutorial.adoc[**Getting Started Tutorial**] - Getting Started with Fedora CoreOS Tutorial, It includes basic configuration steps and serves as a 101 guide for newcomers.
