...
TIP: If you use VScode with the https://github.com/redhat-developer/vscode-yaml[Red Hat Yaml extension] you can associate `*.bu` files to `yaml` in `files.associations` setting and get auto completion and help about butane specs
